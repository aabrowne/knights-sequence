...
class MapClashInspector {
     ...
     * map as a value.
     */
    public static Map<Integer, Integer> getHashClashDistribution(Map<?, ?> map) throws NoSuchFieldException, IllegalAccessException {
     ...
     */
    public static Map<Integer, Integer> getBucketClashDistribution(Map<?, ?> map) throws NoSuchFieldException, IllegalAccessException {
        return getBucketDistribution(map, new MapProcessor() {
            private int size;
    ...
    private static Map<Integer, Integer> getBucketDistribution(Map<?, ?> map, MapProcessor processor) throws NoSuchFieldException, IllegalAccessException {// Since Java 1.7, we can throw ReflectiveOperationException
    ...
    private static Map.Entry<?, ?>[] getTable(Map<?, ?> map) throws NoSuchFieldException, IllegalAccessException {
